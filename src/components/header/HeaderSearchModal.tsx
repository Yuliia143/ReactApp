...
const HeaderSearchModal = ({modalConfig, currentLecture}: ModalLectProps) => {
    return (
        <Modal dimmer='blurring' open={modalConfig.modalOpen} onClose={modalConfig.handleClose}>
            <Modal.Header>Do you want to watch this lecture?</Modal.Header>
            <Modal.Content image>
                <Image
                    wrapped
                    size='medium'
                    src={currentLecture.imgurl}
                />
                <Modal.Description>
            ...
            <Modal.Actions>
                ...
                <Link to='/signin'><Button color='green' inverted onClick={modalConfig.handleClose}>

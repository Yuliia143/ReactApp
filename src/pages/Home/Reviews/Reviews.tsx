        ...
        <div className={classes.flexCategories}>
          ...
          <div className={classes.container}>
            <div className={classes.imgAndName}>
              <img src='https://i.udemycdn.com/user/100x100/8872940_27b4_3.jpg' alt = 'Author' className={classes.image}/>
          ...
          <div className={classes.container}>
            <div className={classes.imgAndName}>
              <img src='https://i.udemycdn.com/user/100x100/22869844_edad.jpg' alt = 'Author' className={classes.image} />
          ...
          <div className={classes.container}>
            <div className={classes.imgAndName}>
              <img src='https://i.udemycdn.com/user/100x100/26154780_76c8.jpg' alt = 'Author' className={classes.image}/>

...
const classes = require('./AfterBanner.module.css');
    ...
    <div>
      <div className={classes.background}>
        ...
        <div className={classes.container}>
          <Icon className='huge check circle outline' id={classes.mainBlock}/>
          <Icon className='big check circle outline' id={classes.block768}/>
          <div>

        ...
        <div className="userDetails" style={{ padding: '30px' }}>
            <Form size="large">
                ...
                <Form.Input
                    ...
                    value={user.surName}
                    onChange={(event, data) =>
                        handleChange(event, data, 'surName')
                    }
                />
                ...
                {!editedUser.id && (
                    <Form.Input
                        ...
                        value={user.password}
                        onChange={(event, data) =>
                            handleChange(event, data, 'password')
                        }
                    />
                )}

                <Form.Field style={{ textAlign: 'end', marginTop: '30px' }}>
                    <Button color="red" inverted onClick={closeDetails}>
                        Cancel
                    </Button>
